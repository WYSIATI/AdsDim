...
describe('urlSignal', () => {
  it.each([
    ...
    ['onlyfans funnel is strong', ['onlyfans.com/somecreator'], 1],
    ['app store push is weak', ['https://apps.apple.com/app/id12345'], 0.5],
    ['play store push is weak', ['https://play.google.com/store/apps/details?id=x'], 0.5],
